...
export class AgeRatingsController {
  constructor(private readonly ageRatingsService: AgeRatingsService) {}
  ...
  async findAll(
    ...
    const result = await this.ageRatingsService.findAll({
      page: parsedPage,
      limit: parsedLimit,
      search,
      orderBy,
  ...
  async findOne(@Param('id') id: string) {
    return await this.ageRatingsService.findOne({ id });
  }
}
